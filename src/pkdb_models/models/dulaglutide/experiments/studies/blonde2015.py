...
class Blonde2015(DulaglutideSimulationExperiment):
    """Simulation experiment of Blonde2015.
    ...
    def datasets(self) -> Dict[str, DataSet]:
        dsets = {}
        for fig_id in ["Fig2a", "Fig2b", "Fig2f"]:
    ...
    def figures(self) -> Dict[str, Figure]:
        ...
        plots[1].set_yaxis(self.label_hba1c, unit=self.unit_hba1c)
...
if __name__ == "__main__":
    run_experiments(Blonde2015, output_dir=Blonde2015.__name__)