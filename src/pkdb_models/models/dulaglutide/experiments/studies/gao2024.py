...
class Gao2024(DulaglutideSimulationExperiment):
    """Simulation experiment of Gao2024."""

    interventions = ["HEC14028", "DUL075"]
    doses = {
        "DUL075": 0.75,  # [mg]
        "HEC14028": 0.75,  # [mg]
    }
...
if __name__ == "__main__":
    run_experiments(Gao2024, output_dir=Gao2024.__name__)
