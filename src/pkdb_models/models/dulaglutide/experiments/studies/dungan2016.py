...
class Dungan2016(DulaglutideSimulationExperiment):
    """Simulation experiment of Dungan2016."""
    ...
    info = {
        "hba1c": "hba1c",  #Fig2B
        "hba1c_change": "hba1c_change",  # Fig2B
        "BW": "bodyweight",  #Fig2F
    ...
    def figures(self) -> Dict[str, Figure]:
        ...
        plots[2].set_yaxis(self.label_bodyweight, unit=self.unit_bodyweight)
        plots[3].set_yaxis(self.label_bodyweight_change, unit=self.unit_bodyweight)
...
if __name__ == "__main__":
    run_experiments(Dungan2016, output_dir=Dungan2016.__name__)
