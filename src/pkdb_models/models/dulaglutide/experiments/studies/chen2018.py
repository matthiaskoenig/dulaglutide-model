...
class Chen2018(DulaglutideSimulationExperiment):
    """Simulation experiment of Chen2018."""
...
if __name__ == "__main__":
    run_experiments(Chen2018, output_dir=Chen2018.__name__)
